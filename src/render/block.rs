...
impl Block {
    ...
    pub fn change_content(&mut self, x :u16, y:u16, content: char, foreground_color: Color, background_color: Color) {
...
impl ScreenElement for Block {
    ...
    fn get_foreground_color(&self, x: u16, y: u16) -> Color { self.foreground_colors[(y * self.width + x) as usize] }
    fn get_background_color(&self, x: u16, y: u16) -> Color { self.background_colors[(y * self.width + x) as usize] }
